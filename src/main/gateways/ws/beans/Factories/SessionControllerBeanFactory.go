...
type SessionControllerBean struct {
}

func NewSessionControllerBean() *SessionControllerBean {
	return &SessionControllerBean{}
}

func (this *SessionControllerBean) Get() *main_gateways_ws_v1.SessionController {
	...
	userController := *main_gateways_ws_v1.NewSessionController(
		*usecaseBeans.EndSession,
		*usecaseBeans.RefreshSession,
		*usecaseBeans.CreateInternalProviderUserSession,
		*usecaseBeans.AtomicLockedCreateExternalAuthProviderUserSession,
