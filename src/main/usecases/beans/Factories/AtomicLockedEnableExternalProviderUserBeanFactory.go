...
type AtomicLockedEnableExternalProviderUserBean struct {
}

func NewAtomicLockedEnableExternalProviderUserBean() *AtomicLockedEnableExternalProviderUserBean {
	return &AtomicLockedEnableExternalProviderUserBean{}
}

func (this *AtomicLockedEnableExternalProviderUserBean) Get() *main_usecases_lockers.AtomicLockedEnableExternalProviderUser {
	...
	return main_usecases_lockers.NewAtomicLockedEnableExternalProviderUser(
		NewEnableExternalProviderUserBean().Get(),
