...
type AtomicLockedChangeInternalProviderUserPasswordBean struct {
}

func NewAtomicLockedChangeInternalProviderUserPasswordBean() *AtomicLockedChangeInternalProviderUserPasswordBean {
	return &AtomicLockedChangeInternalProviderUserPasswordBean{}
}

func (this *AtomicLockedChangeInternalProviderUserPasswordBean) Get() *main_usecases_lockers.AtomicLockedChangeInternalProviderUserPassword {
	...
	return main_usecases_lockers.NewAtomicLockedChangeInternalProviderUserPassword(
		NewChangeInternalProviderUserPasswordBean().Get(),
